...
- Gradle 9.5.0 (if building from source)

### Tested With

- NVDA 2025.3.2 - 2026.1.1
- JAWS 2024
...
- To users upgrading from AudioBug  0.2.4 and older: Before installing AudioBug 0.2.6 and newer, you must remove the old AudioBug
